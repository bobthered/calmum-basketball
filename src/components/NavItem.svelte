...
<a
	...
	bind:this={element}
	class={twMerge(
		'flex flex-col items-center bg-primary-700 pt-3 pb-[max(calc(env(safe-area-inset-bottom),.75rem))] text-white transition duration-200 hover:bg-primary-800 lg:rounded lg:px-6 lg:pb-3 lg:text-primary-700',
